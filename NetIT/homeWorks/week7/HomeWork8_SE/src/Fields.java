...
public class Fields {
	...
	private int     type;
	private boolean isFieldsMovable;;
	...
	public boolean isFieldsMovable() {
		return isFieldsMovable;
	}

	public void setFieldsMovable(boolean isFieldsMovable) {
		this.isFieldsMovable = isFieldsMovable;
	}
